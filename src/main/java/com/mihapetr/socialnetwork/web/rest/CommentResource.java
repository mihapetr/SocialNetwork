...
/**
 * REST controller for managing {@link com.mihapetr.socialnetwork.domain.Comment}.
 */
@RestController
...
public class CommentResource {
    ...
    public ResponseEntity<Comment> partialUpdateComment(
        ...
        Optional<Comment> result = commentRepository.findById(comment.getId()).map(commentRepository::save);
