...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '4111677b-a36c-44b7-91b4-d02a44bd097d' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('b93a8d9a-7d93-4773-addc-ccd140daca3d');
      cy.get(`[data-cy="name"]`).should('have.value', 'b93a8d9a-7d93-4773-addc-ccd140daca3d');
