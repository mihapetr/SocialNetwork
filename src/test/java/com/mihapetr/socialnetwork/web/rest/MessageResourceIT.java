...
import static com.mihapetr.socialnetwork.domain.MessageAsserts.*;
import static com.mihapetr.socialnetwork.web.rest.TestUtil.createUpdateProxyForBean;
import static com.mihapetr.socialnetwork.web.rest.TestUtil.sameInstant;
...
class MessageResourceIT {
    ...
    public static Message createEntity() {
        return new Message().senderName(DEFAULT_SENDER_NAME).content(DEFAULT_CONTENT).time(DEFAULT_TIME);
    }
    ...
    public static Message createUpdatedEntity() {
        return new Message().senderName(UPDATED_SENDER_NAME).content(UPDATED_CONTENT).time(UPDATED_TIME);
    }
    ...
    void putExistingMessage() throws Exception {
        ...
        updatedMessage.senderName(UPDATED_SENDER_NAME).content(UPDATED_CONTENT).time(UPDATED_TIME);
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.senderName(UPDATED_SENDER_NAME).content(UPDATED_CONTENT).time(UPDATED_TIME);
